...
public class myBookingsDB extends SQLiteOpenHelper { // ✅ Extend SQLiteOpenHelper
    ...
    public myBookingsDB(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION); // ✅ Call superclass constructor
    }
    ...
    public long insertRecord(String type, String organization) {
        SQLiteDatabase db = this.getWritableDatabase(); // ✅ No more errors here
    ...
    public Cursor getAllRecords() {
        SQLiteDatabase db = this.getReadableDatabase(); // ✅ No more errors here
